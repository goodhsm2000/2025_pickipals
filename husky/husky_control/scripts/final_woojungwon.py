...
MAP_CHANGE_POSE : dict = {'x' : 42.883 , 'y' : -23.205,'qx' : 0.0 ,'qy' : 0.0 ,'qz' : 1,'qw' : 0.04}

PICKUP_DESTINATION : dict = {'x' : 33.13 , 'y' : -14.46,'qx' : 0.0 ,'qy' : 0.0 ,'qz' : -0.03,'qw' : 1.0}

ELEVATOR_BUTTON_DESTINATION : dict = {'x' : 41.68 , 'y' : -23.18,'qx' : 0.0 ,'qy' : 0.0 ,'qz' : 0,'qw' : 1}

FRONT_ELEVATOR_DESTINATION : dict = {'x' : -3.464 , 'y' : -1.498, 'qx' : 0.0 ,'qy' : 0.0 ,'qz' : -1.0,'qw' : 0.062}

ELEVATOR_DESTINATION : dict = {'x' : -4.914 , 'y' : -1.166,'qx' : 0.0 ,'qy' : 0.0 ,'qz' : 0.67,'qw' : 0.74}

HEADING_POSE : dict = {'x' : -4.934 , 'y' : -1.37,'qx' : 0.0 ,'qy' : 0.0 ,'qz' : -0.01,'qw' : 1.0}

DELIVER_DESTINATION : dict = {'x' : -0.475 , 'y' : -25.133,'qx' : 0.0 ,'qy' : 0.0 ,'qz' : -0.727,'qw' : 0.686}
...
class PickAndPlaceRobot(object):
    ...
    def __init__(self, hz = 100):
        ...
        self.create_floor_button("6층", 6)
        self.create_floor_button("7층", 7)
    ...
    def create_floor_button(self, text, floor_num):
        ...
        button.grid(row=2, column=floor_num-4, padx=5, pady=5, sticky="ew")
